...
The notebook did not specify exact package versions, so `requirements.txt` uses compatible minimum versions where practical rather than inventing notebook-specific pins.
